...
import com.vo.buz.selection.GroupVO;
...
//        SysLog.logRecord();
    ...
    public List<GroupVO> queryAllGroupsForVO(Map<String, Object> map) throws SQLException {
        return this.sqlMapClient.queryForList("group.queryAllGroupsForVO", map);
    }
}
