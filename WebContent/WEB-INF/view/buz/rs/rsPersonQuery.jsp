	...
	<head>
		...
		var dictionaryObj = (dictionaryListStr==""?null:eval("("+dictionaryListStr+")"));
			...
			$(function(){
				...
				grid = new DataGrid("rsPersonQueryGrid","#dg");
				grid.load({});
				setHeight("cc");
    	 	...
    	 	<li>
    	 		<table class="queryPropTable">
    	 			<tr>
    	 				...
    	 				<td class="td2">
    	 					<input type="text" id="jnsj" class="Wdate" onfocus="new WdatePicker({dateFmt:'yyyy-MM-dd'});">
    	 				</td>
    	 			</tr>
    	 		</table>
