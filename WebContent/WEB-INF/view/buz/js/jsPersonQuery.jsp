	...
	<head>
		...
		var dictionaryObj = (dictionaryListStr==""?null:eval("("+dictionaryListStr+")"));
			...
			$(function(){
				...
				grid = new DataGrid("jsPersonQueryGrid","#dg");
				grid.load({});
				setHeight("cc");
    	 	...
    	 	<li>
    	 		<table class="queryPropTable">
    	 			<tr>
    	 				...
    	 				<td class="td2">
    	 					<input type="text" id="hyrq" class="Wdate" onfocus="new WdatePicker({dateFmt:'yyyy-MM-dd'});">
    	 				</td>
    	 			</tr>
    	 		</table>
    	 	...
    	 	<li>
    	 		<table class="queryPropTable">
    	 			<tr>
    	 				...
    	 				<td class="td2">
    	 					<input type="text" id="sysj" class="Wdate" onfocus="new WdatePicker({dateFmt:'yyyy-MM-dd'});">
    	 				</td>
    	 			</tr>
    	 		</table>
    	 	...
    	 	<li>
    	 		<table class="queryPropTable">
    	 			<tr>
    	 				...
    	 				<td class="td2">
    	 					<input type="text" id="byjyrq" class="Wdate" onfocus="new WdatePicker({dateFmt:'yyyy-MM-dd'});">
    	 				</td>
    	 			</tr>
    	 		</table>
