...
<head>
    ...
    <script type="text/javascript">
        ...
        var toolbar = [{
            ...
            handler: function () {
                var buttons = [{
                    ...
                    text: '保存',
                    handler: function () {
                        var normalAreaName = $.trim($('#addNormalArea').find('#normalAreaName').val());
                        var obj = {};
                        if (normalAreaName.length > 0) {
                            obj.normalAreaName = normalAreaName;
                        } else {
                            $.messager.alert('提示', "请填写地区名称！");
                            return;
                        }
                        $.ajax({
                            url: $cntPath + "/normalArea.spr?method=addNormalArea",
                            data: "normalAreaName=" + JSON.stringify(obj),
                            method: "post",
                            dataType: "json",
                            async: false,
                ...
                $('#win').dialog({
                    ...
                    closed: false,
                    cache: false,
                    href: $cntPath + '/normalArea.spr?method=toAddNormalArea',
                    modal: true,
                    buttons: buttons
                });
            }
            ...
            handler: function () {
                ...
                var buttons = [{
                    ...
                    handler: function () {
                        ...
                        $.ajax({
                            ...
                            data: "normalAreaName=" + normalAreaName + "&id=" + id,
                            method: "post",
                            dataType: "json",
                            async: false,
                            success: function (data) {
                ...
                $('#win').dialog({
                    ...
                    closed: false,
                    cache: false,
                    href: $cntPath + '/normalArea.spr?method=toModifyNormalArea',
                    modal: true,
                    buttons: buttons
                });
        ...
        $(function () {
            ...
            grid = new DataGrid("normalAreaQueryGrid", "#dg");
            grid.load({}, {toolbar: toolbar});
            setHeight("cc");
        });
        function query() {
            ...
            <li>
                <table class="queryPropTable">
                    <tr>
                        ...
                        <td class="td2">
                            <input type="text" id="normalAreaName">
                        </td>
                    </tr>
                </table>
            </li>
