        ...
        <div style="width: 100%;height: 100%;">
            <div class="aaron_wrapper">
                <div class="aaron_add_table">
                    <table>
                        <caption style="color: #000000;font-size: 18px;padding-bottom: 5px;padding-top: 10px;"><strong>用户基本信息</strong>
                        </caption>
                        <tr class="aaron_table_selected_col">
                            <td align="right"><span class="aaron_red_star">*</span>用户名：</td>
                            <td class="middle_td"><input name="aaron_user_name" class="aaron_add_txt" type="text"
                                                         id="ULoginName" maxlength="15"/></td>
                            <td>用户名由3-15个字符组成（不含中文、百分号、下划线）</td>
                        </tr>
                        <tr>
                            <td align="right"><span class="aaron_red_star">*</span>密码：</td>
                            <td><input name="aaron_pass" class="aaron_add_txt" type="password" id="addUser_uPassword"/>
                            </td>
                            <td>请填写密码，最小长度为6个字符（不含中文字符）</td>
                        </tr>
                        <tr class="aaron_table_selected_col">
                            <td align="right"><span class="aaron_red_star">*</span>确认密码：</td>
                            <td><input name="aaron_repass" class="aaron_add_txt" type="password"
                                       id="addUser_testUPassword"/></td>
                        ...
                        <tr class="aaron_table_selected_col">
                            ...
                            <td><input type="text" maxLength="11" onblur="checkphone()" id="phone" name="phone"
                            ...
                            <table>
                                ...
                                <tr>
                                    <td width="155" valign="top">
                                        <select class="rolegrp_list" name="rolegrp_list" multiple="multiple"
                                                style="height: 220px;">
                                        </select>
                                    </td>
                                    <td align="center" width="100" valign="top" valign="top">
                                        <div style="margin-bottom:15px;margin-top: 40px;"><input
                                                class="select_all_rolegrp" type="button" value=">>"/></div>
                                        <div style="margin-bottom:15px;"><input class="select_one_rolegrp" type="button"
                                                                                value=">"/></div>
                                        <div style="margin-bottom:15px;"><input class="remove_one_rolegrp" type="button"
                                                                                value="&lt;"/></div>
                                        <div><input class="remove_all_rolegrp" type="button" value="&lt;&lt;"/></div>
                                    </td>
                                    <td align="left" width="100" style="width:175px;" valign="top">
                                        <select class="selected_rolegrp_list" name="selected_rolegrp_list"
                                                multiple="multiple" style="height: 220px;">
                                        </select>
                                    </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table>
                                ...
                                <tr>
                                    <td width="155" valign="top">
                                        <select class="role_list" name="role_list" multiple="multiple"
                                                style="height: 220px;">
                                        </select>
                                    </td>
                                    <td align="center" width="100" valign="top" valign="top">
                                        <div style="margin-bottom:15px;margin-top: 40px;"><input class="select_all"
                                                                                                 type="button"
                                                                                                 value=">>"/></div>
                                        <div style="margin-bottom:15px;"><input class="select_one" type="button"
                                                                                value=">"/></div>
                                        <div style="margin-bottom:15px;"><input class="remove_one" type="button"
                                                                                value="&lt;"/></div>
                                        <div><input class="remove_all" type="button" value="&lt;&lt;"/></div>
                                    </td>
                                    <td align="left" width="100" style="width:175px;" valign="top">
                                        <select class="selected_role_list" name="selected_role_list" multiple="multiple"
                                                style="height: 220px;">
                                        </select>
                                    </td>
                                    <%--<td style="vertical-align: top;" align="left">--%>
